...
const menuItems = [
  ...
  { name: "Profile & Resume", path: "/profile-resume", icon: "👤" },
  { name: "Resume Analysis", path: "/resume-analysis", icon: "📊" },
  { name: "ATS Analysis", path: "/ats-analysis", icon: "🎯" },
  { name: "Resume Optimizer", path: "/resume-optimizer", icon: "📑" },
  { name: "Resume Chat", path: "/resume-chat", icon: "🤖" },
  { name: "Opportunities", path: "/opportunities", icon: "💼" },
  { name: "Company Hub", path: "/company-hub", icon: "🏢" },
  { name: "Applications", path: "/applications", icon: "📋" },
  { name: "Notifications", path: "/notifications", icon: "🔔" },
  { name: "Interview Prep", path: "/interview-prep", icon: "🎤" },
  { name: "Cover Letter", path: "/cover-letter", icon: "📝" },
